...
- **Tu mes:** tarjeta con "Tu mes" y "sin contar hoy" a la derecha; cifra display "78" con "de 93" en 20px text-muted y la explicación "veces que cumpliste tus hábitos programados, y N congeladas con comodín. Un día gris no borra los demás." Debajo, solo los contadores mayores que cero: "N días completos" y "N comodines usados". Cuenta: se suman los hábitos programados de cada día del mes hasta ayer; los pendientes de un día congelado se cuentan aparte como congelados, nunca como cumplidos. Congelar un día no cambia ninguna de las dos cifras (cumplidos ni programados); solo suma congeladas. Los hábitos semanales no entran en esta cuenta.
