...
- **No encontramos tu compra:** "Escribiste {correo}, pero no aparece ninguna compra de Racha con ese correo." y dos puntos: "Revisa que sea el mismo correo que usaste al pagar en Hotmart. Búscalo en el correo de confirmación de Hotmart." / "Si acabas de pagar, espera un par de minutos y vuelve a intentar." Botón "Probar con otro correo"; link "Escribir a soporte".
